...
const EstoqueDomesticoPrivacyIos = () => {
  return (
      ...
      <section className="bg-gradient-hero px-4 py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-hero-foreground/60">
            Estoque Doméstico para iOS (iPhone e iPad)
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16 bg-white">
        <div className="max-w-3xl mx-auto prose prose-gray max-w-none space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            alimentos para iPhone e iPad, desenvolvido por Edilson. O app
            permite escanear códigos de barras, registrar itens da despensa,
            controlar datas de validade e receber alertas antes dos produtos
            vencerem.
          </p>
          <p>
          ...
          <p>
            ...
            SwiftData, sem dependências externas de coleta de dados.
          </p>
...
export default EstoqueDomesticoPrivacyIos;
