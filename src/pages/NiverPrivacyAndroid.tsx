      ...
      <section className="px-4 py-16 bg-white">
        <div className="max-w-3xl mx-auto prose prose-gray max-w-none space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            gratuito de acompanhamento de aniversários para Android, desenvolvido
            por Edilson. O app permite registrar datas de aniversário, importar
            contatos e receber lembretes para não esquecer de ninguém.
          </p>
          <p>
          ...
          <p>
            O Niver pode solicitar acesso às seguintes permissões do seu
            dispositivo:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong className="text-foreground">Contatos:</strong> Para
              importar nomes e datas de aniversário dos seus contatos. O acesso é
              feito apenas quando você inicia a importação manualmente.
            </li>
            <li>
              <strong className="text-foreground">Calendário:</strong> Para
              importar eventos de aniversário do seu calendário. O acesso também
              ocorre apenas por ação sua.
            </li>
            <li>
          ...
          <p>
            ...
            , utilizando um banco de dados Room (SQLite). Isso inclui nomes,
            datas de aniversário e ideias de presentes.
          </p>
          <p>
          ...
          <p>
            ...
            de analytics, rastreamento ou coleta de dados. Não usamos Google
            Analytics, Firebase Analytics, nem qualquer serviço semelhante.
          </p>
...
export default NiverPrivacyAndroid;
